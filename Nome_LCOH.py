...
resource_year = 2013 #TODO: 2018
atb_years = [2020, 2025, 2030, 2035] #2020 represents current (moderate) cost landscape
...
sitelist_name = 'filtered_site_details_Nome.csv'
...
results_dir = parent_path + '/examples/H2_Analysis/results_Nome'
