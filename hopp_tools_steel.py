...
def set_electrolyzer_info(hopp_dict, atb_year, electrolysis_scale, electrolyzer_replacement_scenario,turbine_rating,direct_coupling=True):
    ...
    if atb_year == 2020: #for nome for moderate estimates
        
        electrolyzer_energy_kWh_per_kg = 55
        
        # Centralized costs and scales for 2020
        component_costs_centralized = {'Stack':230.8,'Power Electronics':222.5,'BOP':150.5,'H2 Conditioning':62.8} #Current - Moderate
    ...
    #         time_between_replacement = 13334    #[hrs]
        ...
        # DO NOT USE # component_costs_centralized = {'Stack':519.5,'Power Electronics':500.5,'BOP':338.5,'H2 Conditioning':141.5} #Current - Conservative

        # component_costs_centralized = {'Stack':346.3,'Power Electronics':333.7,'BOP':225.7,'H2 Conditioning':94.3} #Current - Conservative
        # component_costs_centralized = {'Stack':230.8,'Power Electronics':222.5,'BOP':150.5,'H2 Conditioning':62.8} #Current - Moderate
        ...
        electrolyzer_energy_kWh_per_kg = 51
